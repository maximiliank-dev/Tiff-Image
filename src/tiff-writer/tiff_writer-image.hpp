...
class BitlevelImage : public TiffWriterImgType {
   public:
    ...
    void tags_to_set() {
        ...
        this->_values[TiffTagType::XResolution] =
            make_variant(TiffTagType::XResolution, 122333);
        this->_values[TiffTagType::YResolution] =
            make_variant(TiffTagType::YResolution, 133333);
        this->_values[TiffTagType::ResolutionUnit] =
            make_variant(TiffTagType::ResolutionUnit, 2);
        // set to unsigned type
        this->_values[TiffTagType::SampleFormat] =
            make_variant(TiffTagType::SampleFormat, 1);
        // set to unsigned type
...
class GrayImage : public BitlevelImage {
   public:
    ...
    void tags_to_set() {
        ...
        this->_values[TiffTagType::BitsPerSample] =
            make_variant(TiffTagType::BitsPerSample, 8);
    }
};
...
class RGBImage : public BitlevelImage {
   public:
    ...
    void tags_to_set() {
        ...
        this->_values[TiffTagType::SamplesPerPixel] =
            make_variant(TiffTagType::SamplesPerPixel, 3);
        // pixel are stored in order
        this->_values[TiffTagType::PlanarConfiguration] =
            make_variant(TiffTagType::PlanarConfiguration, 1);
        this->_values[TiffTagType::PhotometricInterpretation] =
            make_variant(TiffTagType::PhotometricInterpretation, 2);
        this->_values[TiffTagType::BitsPerSample] =
            make_variant(TiffTagType::BitsPerSample, {8, 8, 8});
        this->_values[TiffTagType::SampleFormat] =
            make_variant(TiffTagType::SampleFormat, {1, 1, 1});
    }
};
